<div class="container">
    ...
    <div class="row">
        ...
        <div class="form-group">
            <?= form_label("Nom&nbsp;:", "name", ['class' => "col-md-5"]) ?>
        ...
        <div class="form-group">
            <?= form_label("Mail&nbsp;:", "email", ['class' => "col-md-5"]) ?>
        ...
        <div class="form-group">
            <?= form_label("Confirmer mail&nbsp;:", "email_confirme", ['class' => "col-md-5"]) ?>
        ...
        <div class="form-group">
            <?= form_label("Titre&nbsp;:", "title", ['class' => "col-md-5"]) ?>
        ...
        <div class="form-group">
            <?= form_label("Message&nbsp;:", "message", ['class' => "col-md-5"]) ?>
