    ...
    <div class="col-md-12">
      ...
      <div class="form-group">
        ...
        <div class="col-md-10 <?= empty(form_error('title')) ?"" : "has-error " ?> ">
          <?= form_input(['name' => "title", 'id' => "title", 'class' => 'form-control border-top-0 border-right-0 rounded-0 border-warning', 'placeholder' => "ex: Nom premier article"], set_value('title')) ?>
      ...
      <div class="form-group">
        ...
        <div class="col-md-10 <?= empty(form_error('content')) ?"" : "has-error" ?>">
          <?= form_textarea(['name' => "content", 'id' => "content", 'class' => 'form-control border-top-0 border-right-0 rounded-0 border-warning', 'placeholder' => "Ecrire votre article..."], set_value('content')) ?>
      ...
      <div class="form-group">
        ...
        <div class="col-md-10 <?= empty(form_error('status')) ?"" : "has-error" ?>">
          <?= form_dropdown("status", $this->article_status->text, set_value('status'), ['id' => "content", 'class' => 'form-control border-top-0 border-right-0 rounded-0 border-warning']) ?>
